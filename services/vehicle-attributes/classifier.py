...
BODY_CONF = float(os.environ.get("BODY_CONF_THRESHOLD", "0.50"))
MAKE_CONF = float(os.environ.get("MAKE_CONF_THRESHOLD", "0.50"))
MODEL_CONF = float(os.environ.get("MODEL_CONF_THRESHOLD", "0.55"))
